...
loop do # main loop
  ...
  prompt('Please insert the amount of time of your loan (in months):')
  ...
  prompt("Your loan amount is: #{monthly_payment}")

  prompt('Recalculate? Type Y to continue.')
